  ...
  return (
    <>
      <SectionIntro
        ...
        title="We help students through tailored education that is powered by AI."
        className="mt-24 sm:mt-32 lg:mt-40"
      >
        <p>
      ...
      <Container className="mt-16">
        <div className="lg:flex lg:items-center lg:justify-end">
          ...
          <List className="mt-16 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] lg:pl-4">
            ...
            <ListItem title="Sophisticated">
              We are at the forefront of modern AI development. We use the latest tools
              and are building off the latest academia in terms of how we treat individualized AI.
            </ListItem>
            <ListItem title="Cheap">
              Our early statistics have shown that the cost relative to the improvement is drastic
              and we will be coming out with official statistics soon.
            </ListItem>
          </List>
        </div>
      </Container>
...
export const metadata: Metadata = {
  description:
    'We are company determined to create individualized tutoring.',
}
